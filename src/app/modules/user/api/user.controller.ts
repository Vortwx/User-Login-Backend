import { Controller, Get, Param, UseGuards, HttpStatus, Res, ParseUUIDPipe, HttpCode } from '@nestjs/common';
...
export class UserController {
    ...
    async getUserProfile(@Param('id', ParseUUIDPipe) id: string, @Res() res: Response) {
      try {
