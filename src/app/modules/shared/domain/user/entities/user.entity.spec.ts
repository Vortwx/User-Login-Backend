...
describe('User Entity', () => {
    ...
    it('should throw an error if username is empty', () => {
        expect(
            () => new User(mockId, '', mockPhoneNumber, mockHashedPassword),
    ...
    it('should throw an error if phone number is invalid (too short)', () => {
        expect(
            () => new User(mockId, mockUsername, '123', mockHashedPassword),
    ...
    it('should throw an error if hashed password is empty', () => {
        expect(
            () => new User(mockId, mockUsername, mockPhoneNumber, ''),
    ...
    it('should throw an error when updating with an invalid phone number', () => {
        ...
        expect(() => user.updatePhoneNumber('invalid')).toThrow(
            'Invalid new phone number format. Must be at least 10 digits.',
        );
    });
    ...
    it('should throw an error when updating with an empty hashed password', () => {
        ...
        expect(() => user.updateHashedPassword('')).toThrow(
